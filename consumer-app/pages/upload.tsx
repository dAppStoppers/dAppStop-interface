    ...
    <div className="container flex justify-center pt-8 pb-20">
      <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="form-control mb-5">
          ...
          <label className="input-group rounded-sm">
            <input
              type="text"
        ...
        <div className="form-control mb-5">
          <label className="label">
            <span className="label-text text-lg">Preview images (up to 2)</span>
          </label>
          <label className="uploader-group flex">
            <img
              src="/icons/Image-uploader-rectangle.svg"
              className="mr-4"
              alt="image uploader"
            />
            <img
        ...
        <div className="form-control mb-5">
          ...
          <div className="dropdown">
            ...
            >
              <li>
                <a>
                  <img src="/icons/MATIC.png" className="w-8" alt="MATIC" />
                  Polygon
                </a>
              </li>
              <li>
              ...
              <li>
                <a>
                  <img src="/icons/Klaytn.png" className="w-8" alt="Klaytn" />
                  Klaytn
                </a>
              </li>
            </ul>
          ...
          <div className="form-control mb-5">
            <label className="label cursor-pointer">
              <span className="label-text text-base">
                If you turn it on, we will generate non-transferrable NFT
                (ERC-1155) and users need to buy it for installing your app.
              </span>
          ...
          <label className="input-group flex">
            ...
            <div className="dropdown">
              ...
              >
                <li>
                  <a>
                    <img src="/icons/ETH.png" className="w-8" alt="ETH" />
                    ETH
                  </a>
                </li>
                <li>
